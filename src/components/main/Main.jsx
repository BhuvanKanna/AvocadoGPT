...
export default function Main() {
  ...
  const handleCardClick = (prompt) => {
    setInput(prompt); // Set the input state to the prompt
    onSent(prompt);   // Call onSent with the prompt directly
  };
      ...
      <div className="main-container">
        {
          ...
          <>
            ...
            <div className="cards">
              <div onClick={() => setInput("What are the best practices for feeding a newborn?")} className="card">
                <p>What are the best practices for feeding a newborn?</p>
                <img src={assets.lightbulb} alt="Compass icon" />
              </div>
              <div onClick={() => setInput("How can I help my child sleep better at night?")} className="card">
                <p>How can I help my child sleep better at night?</p>
                <img src={assets.lightbulb} alt="Lightbulb icon" />
              </div>
              <div onClick={() => setInput("What are the symptoms of teething in babies?")} className="card">
                <p>What are the symptoms of teething in babies?</p>
                <img src={assets.lightbulb} alt="Messenger icon" />
              </div>
              <div onClick={() => setInput("How do I know if my child is reaching developmental milestones?")} className="card">
